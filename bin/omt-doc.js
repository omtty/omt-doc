...
switch (script) {
  ...
  case 'server':
  case 'dev':
    console.log('Welcome to use omt-doc tool, current version is '+ require('../package.json').version);
    result = spawn.sync(
      'node',
      ['--max_old_space_size=8192', require.resolve(`../lib/index.js`)].concat(['--cmd', script]),
